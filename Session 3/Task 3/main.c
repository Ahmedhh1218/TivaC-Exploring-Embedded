...
*
*	Description: 	Main application source file. This file uses the I2C communication method to communicate with an arduino UNO board and
*			control its BUILTIN LED
*
*************************************************************************************************************************************************/
