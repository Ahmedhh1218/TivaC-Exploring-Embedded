/************************************************************************************************************************************************
*
*	File Name: PORT_Configuration.h
*
*	Author: Ahmed Hisham Fathy Hassabou
*
*	Description: header file for configuring ports on TM4C123GH6PM microcontroller. This file contains macros, constants, and function prototypes
*	             for configuring various ports and pins for specific functionalities.
*
***************************************************************************************************************************************************/
...
#define Pedestrian_Port								GPIO_PORTA_BASE
#define PA0														(1<<0)
#define PA1														(1<<1)
#define E_W_Pedestrian_Red						(1<<2)
#define E_W_Pedestrian_Green					(1<<3)
#define N_S_Pedestrian_Red						(1<<4)
#define N_S_Pedestrian_Green					(1<<5)
#define E_W_Pedestrian_PB							(1<<6)
#define N_S_Pedestrian_PB							(1<<7)


#define Cars_Port											GPIO_PORTB_BASE
#define E_W_Car_Red										(1<<0)
#define E_W_Car_Green									(1<<1)
#define E_W_Car_Yellow								(1<<2)
#define N_S_Car_Red										(1<<3)
#define N_S_Car_Green									(1<<4)
#define N_S_Car_Yellow								(1<<5)
#define PB6														(1<<6)
#define PB7														(1<<7)
